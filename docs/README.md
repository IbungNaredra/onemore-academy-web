...
| File | Description |
|------|-------------|
| **[PRD-V2.2-IMPLEMENTATION.md](PRD-V2.2-IMPLEMENTATION.md)** | **Current:** shipped scope vs PRD v2.2 Option A (routes, schema, gaps) |
...
| **[GOOGLE-SHEETS.md](GOOGLE-SHEETS.md)** | **Deprecated** — applied to v1.3 only; v2.2 has no Sheet sync |

Project setup and repo layout: **[`../README.md`](../README.md)** (repository root).
